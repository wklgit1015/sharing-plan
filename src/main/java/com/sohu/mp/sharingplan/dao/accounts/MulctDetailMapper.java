...
public interface MulctDetailMapper {
    ...
    @Insert({
            ...
            "(user_id, passport, right_interest_code, source, period_day, amount, status, operator, reason, create_time)",
            "values",
            "(#{mulctDetail.userId}, #{mulctDetail.passport}, #{mulctDetail.rightInterestCode}, #{mulctDetail.source},",
            "#{mulctDetail.periodDay}, #{mulctDetail.amount}, #{mulctDetail.status}, #{mulctDetail.operator},",
